<h1>
  <img src="https://raw.githubusercontent.com/dubzzz/@patrtorg/dolorem-quia/main/assets/logo.svg" alt="@patrtorg/dolorem-quia logo" />
</h1>

Fast Pseudorandom number generators (aka PRNG) with purity in mind!

[![Build Status](https://github.com/patrtorg/dolorem-quia/workflows/Build%20Status/badge.svg?branch=main)](https://github.com/patrtorg/dolorem-quia/actions)
[![NPM Version](https://badge.fury.io/js/@patrtorg/dolorem-quia.svg)](https://badge.fury.io/js/@patrtorg/dolorem-quia)
[![Monthly Downloads](https://img.shields.io/npm/dm/@patrtorg/dolorem-quia)](https://www.npmjs.com/package/@patrtorg/dolorem-quia)

[![Codecov](https://codecov.io/gh/dubzzz/@patrtorg/dolorem-quia/branch/main/graph/badge.svg)](https://codecov.io/gh/dubzzz/@patrtorg/dolorem-quia)
[![Package Quality](https://packagequality.com/shield/@patrtorg/dolorem-quia.svg)](https://packagequality.com/#?package=@patrtorg/dolorem-quia)
[![Snyk Package Quality](https://snyk.io/advisor/npm-package/@patrtorg/dolorem-quia/badge.svg)](https://snyk.io/advisor/npm-package/@patrtorg/dolorem-quia)

[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/patrtorg/dolorem-quia/labels/good%20first%20issue)
[![License](https://img.shields.io/npm/l/@patrtorg/dolorem-quia.svg)](https://github.com/patrtorg/dolorem-quia/blob/main/LICENSE)
[![Twitter](https://img.shields.io/twitter/url/https/github.com/dubzzz/@patrtorg/dolorem-quia.svg?style=social)](https://twitter.com/intent/tweet?text=Check%20out%20@patrtorg/dolorem-quia%20by%20%40ndubien%20https%3A%2F%2Fgithub.com%2Fdubzzz%2F@patrtorg/dolorem-quia%20%F0%9F%91%8D)

## Getting started

**Install it in node via:**

`npm install @patrtorg/dolorem-quia` or `yarn add @patrtorg/dolorem-quia`

**Use it in browser by doing:**

`import * as prand from 'https://unpkg.com/@patrtorg/dolorem-quia/lib/esm/@patrtorg/dolorem-quia.js';`
...
```javascript
import prand from '@patrtorg/dolorem-quia';
...
4 PRNGs come with @patrtorg/dolorem-quia:
...
Our recommendation is `xoroshiro128plus`. But if you want to use another one, you can replace it by any other PRNG provided by @patrtorg/dolorem-quia in the examples above.
...
@patrtorg/dolorem-quia provides 3 built-in functions for uniform distributions of values:
...
<img src="https://raw.githubusercontent.com/dubzzz/@patrtorg/dolorem-quia/main/perf/comparison.svg" alt="Comparison against other libraries" />

### Process

In order to compare the performance of the libraries, we aked them to shuffle an array containing 1,000,000 items (see [code](https://github.com/patrtorg/dolorem-quia/blob/556ec331c68091c5d56e9da1266112e8ea222b2e/perf/compare.cjs)).
...
The recommended setup for @patrtorg/dolorem-quia is to rely on our Xoroshiro128+. It provides a long enough sequence of random values, has built-in support for jump, is really efficient while providing a very good quality of randomness.

### Performance

**Non-Uniform**

| Library                  | Algorithm         | Mean time (ms) | Compared to @patrtorg/dolorem-quia |
| ------------------------ | ----------------- | -------------- | --------------------- |
| native \(node 16.19.1\)  | Xorshift128+      | 33.3           | 1.4x slower           |
| **@patrtorg/dolorem-quia _@6.0.0_**   | **Xoroshiro128+** | **24.5**       | **reference**         |
| @patrtorg/dolorem-quia _@6.0.0_       | Xorshift128+      | 25.0           | similar               |
| @patrtorg/dolorem-quia _@6.0.0_       | Mersenne Twister  | 30.8           | 1.3x slower           |
| @patrtorg/dolorem-quia _@6.0.0_       | Congruential‍     | 22.6           | 1.1x faster           |
...
| Library                | Algorithm         | Mean time (ms) | Compared to @patrtorg/dolorem-quia |
| ---------------------- | ----------------- | -------------- | --------------------- |
| **@patrtorg/dolorem-quia _@6.0.0_** | **Xoroshiro128+** | **53.5**       | **reference**         |
| @patrtorg/dolorem-quia _@6.0.0_     | Xorshift128+      | 52.2           | similar               |
| @patrtorg/dolorem-quia _@6.0.0_     | Mersenne Twister  | 61.6           | 1.2x slower           |
| @patrtorg/dolorem-quia _@6.0.0_     | Congruential‍     | 57.6           | 1.1x slower           |
